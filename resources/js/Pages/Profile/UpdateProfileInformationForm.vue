    ...
    <jet-form-section @submitted="updateProfileInformation">
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <jet-input id="username" type="text" class="mt-1 block w-full" v-model="form.username" autocomplete="username" required/>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <jet-input id="site" type="url" class="mt-1 block w-full" v-model="form.site" autocomplete="site" />
